...
const FormLayoutsPage = () => {
    ...
    const { name, email, contact } = tableData;
    ...
    const onSubmit = async e => {
      e.preventDefault();
      await axios.put(`http://localhost:5000/api/put/${id}`, {
        name,
        contact,
        email,
      }).then(() => {setTableData({name : "",email:"",contact:""});
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Edit details</BlockTitle>
          ...
          <Row className="g-gs">
            <Col lg="6">
              ...
              <form onSubmit={e => onSubmit(e)}>
                  ...
                  <button className="btn btn-warning btn-block" value={id ? "update" : ''}>Update User</button>
                </form>
              </PreviewCard>
            </Col>
          </Row>
