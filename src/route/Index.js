...
import crud from "../pages/components/table-two/crud";
import list from "../pages/components/table-three/list";
import userList from "../pages/components/user/userList";
import userDeleted from "../pages/components/user/userDeleted";
import userEdit from "../pages/components/user/userEdit";
import userView from "../pages/components/user/userView";
import userAdd from "../pages/components/user/userAdd";
import add from "../pages/components/table-three/add";
import edit from "../pages/components/table-three/edit";
// import crudList from "../pages/components/table-four/crudList";
...
const Pages = () => {
  ...
  //   uri: "http://localhost:1860/graphql",
        ...
        <Suspense fallback={<div />}>
          ...
          >
            <Switch>
              ...
              <Route exact path={`${process.env.PUBLIC_URL}/crud`} component={crud}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/list`} component={list}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/add`} component={add}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/userAdd`} component={userAdd}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/userList`} component={userList}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/userDeleted`} component={userDeleted}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/userEdit/:id`} component={userEdit}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/userView/:id`} component={userView}></Route>
              <Route exact path={`${process.env.PUBLIC_URL}/edit/:id`} component={edit}></Route>
              {/* <Route exact path={`${process.env.PUBLIC_URL}/crudList`} component={crudList}></Route> */}
